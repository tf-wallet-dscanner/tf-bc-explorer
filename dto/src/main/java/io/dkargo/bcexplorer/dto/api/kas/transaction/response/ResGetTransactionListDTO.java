...
public class ResGetTransactionListDTO {
    ...
    private List<GetTransaction> list;
    ...
    public ResGetTransactionListDTO(Integer number, Integer size, Integer totalPageCount, Long totalElementCount, List<ResGetTransactionDTO> resGetTransactionDTOS) {
        ...
        List<GetTransaction> getTransactionList = new ArrayList<>();
